...
namespace AbstraX.Generators.Client.Validator
{
    ...
    #line 1 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
...
#line hidden
        ...
        public override string TransformText()
        {
            ...
            #line 19 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
    ...
    foreach (var import in this.Imports)
    {
        this.WriteLine(import.DeclarationCode);
            ...
            #line 34 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
            ...
            #line 36 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
            ...
            #line 40 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
    ...
    this.Write(builder.ToString());
            ...
            #line 59 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
    ...
    foreach (var formField in this.FormFields.GetDisplayed())
    {
        var validationSet = formField.ValidationSet;
            ...
            #line 65 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
            ...
            #line 66 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
        ...
        foreach (var entry in validationSet.ValidationEntries)
        {
            ...
            #line 71 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
            ...
            #line 73 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
            ...
            #line 74 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
            ...
            #line 77 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
            ...
            #line 84 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(this.MakeVariable(modelVariable, formField.Name)));
            ...
            #line 90 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
            ...
            #line 97 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(modelVariable));
            ...
            #line 99 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(modelVariable));
            ...
            #line 108 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
    ...
    foreach (var formField in this.FormFields.GetDisplayed())
    {
        builder.AppendWithLeadingIfLength(", ", string.Format("{0} : {1}", this.MakeVariable(modelVariable, formField.Name), formField.ClientDataType));
            ...
            #line 118 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
            ...
            #line 120 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(modelVariable));
            ...
            #line 121 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
    ...
    foreach (var formField in this.FormFields.GetDisplayed())
    {
            ...
            #line 125 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(this.MakeVariable(modelVariable, formField.Name)));
            ...
            #line 126 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
            ...
            #line 131 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(modelVariable));
            ...
            #line 135 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(modelVariable));
            ...
            #line 140 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(modelVariable));
  ...
  getValidationErrors(fieldName: string, checkTouched: boolean = true): string[] {
    ...
    let control = <FormControl>this.");
            ...
            #line 160 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(modelVariable));
  ...
  getValidationErrorsText(fieldName: string): string {
    ...
    let control = <FormControl>this.");
            ...
            #line 177 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(modelVariable));
...
");
            ...
            #line 194 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
    ...
    foreach (var formField in this.FormFields)
    {
            ...
            #line 198 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(this.MakeVariable(modelVariable, formField.Name)));
            ...
            #line 204 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
            ...
            #line 207 "D:\MC\CloudIDEaaS\root\ApplicationGenerator\Generators\Client\Validator\ValidatorClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(modelVariable));
