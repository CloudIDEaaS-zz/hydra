        ...
        internal class TreeNode
        {
                    ...
                    if (Parent != null)
                    {
                        ...
                        {	// if this branch is unbalanced..
                            ...
                            try
                            {
                                ...
                                Children[(int)BTreeIndex.Collections.BTree.ChildNodes.LeftChild] = LeftNode;
                                Children[(int)BTreeIndex.Collections.BTree.ChildNodes.RightChild] = RightNode;
                                //SUCCESSFUL!
                                return;
                            }
                            catch (Exception)
                        ...
                        else
                        {
                            ...
                            try
                            {
                                ...
                                // assign the new children nodes.
                                ParentBTree.TempParentChildren[(int)BTreeIndex.Collections.BTree.ChildNodes.LeftChild] = this;
                                ParentBTree.TempParentChildren[(int)BTreeIndex.Collections.BTree.ChildNodes.RightChild] = RightNode;
            ...
            internal void Promote(BTreeAlgorithm<TKey, TValue> ParentBTree, byte Position)
            {
                ...
                if (NoOfOccupiedSlots < (byte)ParentBTree.SlotLength)
                {
                    ...
                    Children[Index] = ParentBTree.TempParentChildren[(int)BTreeIndex.Collections.BTree.ChildNodes.LeftChild];
                    // insert the right child
                    ShiftSlots(Children, (byte)(Index + 1), (byte)(NoOfOccupiedSlots + 1));
                    Children[Index + 1] = ParentBTree.TempParentChildren[(int)BTreeIndex.Collections.BTree.ChildNodes.RightChild];
                    count++;
                    return;	// successful
                }
                else
                {	// *** Insert to temp slots.. node is full, use pTempSlots
                    ...
                    // insert the left child
                    ParentBTree.TempChildren[Index] = ParentBTree.TempParentChildren[(int)BTreeIndex.Collections.BTree.ChildNodes.LeftChild];
                    // insert the right child
                    ShiftSlots(ParentBTree.TempChildren, (byte)(Index + 1), (byte)(NoOfOccupiedSlots + 1));
                    ParentBTree.TempChildren[Index + 1] = ParentBTree.TempParentChildren[(int)BTreeIndex.Collections.BTree.ChildNodes.RightChild];
