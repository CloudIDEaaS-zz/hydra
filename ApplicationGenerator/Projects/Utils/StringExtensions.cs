...
namespace Utils
{
    public static class StringExtensions
    {
        ...
        public static IEnumerable<string> GetLines(this string str, bool removeEmpty = false)
        {
            ...
            {
                using (var stringReader = new StringReader(str.Trim()))
                {
                    string line;
        ...
        public static void InsertLineTabIndent(this StringBuilder builder, int index, int count, string text)
        {
            var builderTemp = new StringBuilder();

            builderTemp.AppendLineTabIndent(count, text);
