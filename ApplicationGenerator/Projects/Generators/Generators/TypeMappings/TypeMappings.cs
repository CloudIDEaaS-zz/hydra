...
namespace AbstraX.TypeMappings
{
    public static class TypeMapper
    {
        ...
        public class TypeMappings
        {
            ...
            public TypeMappings()
            {
                var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("AbstraX.ClientInterfaces.TypeMappings.Schemas.XMLSchema.xsd");

                if (stream == null)
                {
                    stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("AbstraX.TypeMappings.Schemas.XMLSchema.xsd");
                    serverVersion = true;
                }
