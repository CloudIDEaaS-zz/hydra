    ...
    public static class CompareExtensions
    {
        ...
        public static bool CompareWith(this object valueTest, CompareWithAdditionalComparer additionalComparer, bool performParse, params object[] values)
        {
            foreach (var value in values)
            {
                ...
                else if (value is byte && valueTest is byte && ((byte)valueTest) == ((byte)value))
                {
                    return true;
                }
        ...
        public static bool IsBetween(this DateTime value, DateTime lower, DateTime upper, bool inclusive = true)
        {
            if (inclusive)
            {
