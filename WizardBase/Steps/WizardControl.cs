...
namespace WizardBase
{
    ...
    public class WizardControl : Control
    {
        ...
        private void DoReLayout(int newIndex)
        {
            ...
            wizardStep = WizardSteps[newIndex];
            wizardStep.WizardControl = this;

            controlHost.Controls.Add(wizardStep);
        ...
        {
            this.NavigationDirection = NavigationDirection.Back;
        ...
        protected virtual void OnNextButtonClick(object sender, EventArgs e)
        {
            ...
            {
                num = 0;
                if (!(WizardSteps[CurrentStepIndex] is StartStep) && !WizardSteps[CurrentStepIndex].IsStartStep)
                {
