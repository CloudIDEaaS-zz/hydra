...
using AbstraX.Generators.Pages.$basename$Page;
...
namespace AbstraX.FacetHandlers
{
    ...
    public class $basename$PageFacetHandler : BasePageFacetHandler
    {
        public override bool Process(IBase baseObject, Facet facet, IGeneratorConfiguration generatorConfiguration)
        {
            ...
            module.UIKind = uiAttribute.UIKind;
            module.UIHierarchyPath = uiAttribute.UIHierarchyPath;

            $basename$PageGenerator.GeneratePage(baseObject, pagesPath, name, generatorConfiguration, module, imports, inputObjects /* , .. TODO - add additional parameters */);
