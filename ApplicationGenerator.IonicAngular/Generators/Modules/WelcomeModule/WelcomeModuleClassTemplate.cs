...
namespace AbstraX.Generators.Modules.WelcomeModule
{
    ...
    #line 1 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Modules\WelcomeModule\WelcomeModuleClassTemplate.tt"
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "16.0.0.0")]
    public partial class WelcomeModuleClassTemplate : AbstraX.Generators.Base.TemplateBase
    {
#line hidden
        /// <summary>
        ...
        {
            this.Write("import { NgModule } from \'@angular/core\';\r\nimport { IonicModule } from \'@ionic/an" +
                    "gular\';\r\nimport { CommonModule } from \'@angular/common\';\r\n");
            
            #line 22 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Modules\WelcomeModule\WelcomeModuleClassTemplate.tt"
    ...
    // TODO - add module specific imports below this block
            ...
            #line 38 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Modules\WelcomeModule\WelcomeModuleClassTemplate.tt"
    ...
    this.WriteLine(builder.ToString());
            ...
            #line 49 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Modules\WelcomeModule\WelcomeModuleClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(this.RoutingModuleName));
            
            #line default
            #line hidden
            this.Write(",\r\n");
            
            #line 50 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Modules\WelcomeModule\WelcomeModuleClassTemplate.tt"
    ...
    if (this.AngularModule.Imports.Count > 0)
    {
        ...
        this.WriteLine(builder.ToString());
            ...
            #line 63 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Modules\WelcomeModule\WelcomeModuleClassTemplate.tt"
            ...
            #line 64 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Modules\WelcomeModule\WelcomeModuleClassTemplate.tt"
    ...
    if (this.AngularModule.Providers.Count > 0)
    {
        this.WriteLine(",");
            ...
            #line 70 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Modules\WelcomeModule\WelcomeModuleClassTemplate.tt"
        ...
        this.WriteLine(builder.ToString());
            ...
            #line 80 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Modules\WelcomeModule\WelcomeModuleClassTemplate.tt"
    ...
    if (this.AngularModule.Exports.Count > 0)
    {
        this.WriteLine(",");
            ...
            #line 88 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Modules\WelcomeModule\WelcomeModuleClassTemplate.tt"
        ...
        this.WriteLine(builder.ToString());
            ...
            #line 99 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Modules\WelcomeModule\WelcomeModuleClassTemplate.tt"
            ...
            #line 103 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Modules\WelcomeModule\WelcomeModuleClassTemplate.tt"
...
private string _RoutingModuleNameField;

/// <summary>
/// Access the RoutingModuleName parameter of the template.
/// </summary>
private string RoutingModuleName
{
    get
    {
        return this._RoutingModuleNameField;
    }
}
...
bool RoutingModuleNameValueAcquired = false;
if (this.Session.ContainsKey("RoutingModuleName"))
{
    this._RoutingModuleNameField = ((string)(this.Session["RoutingModuleName"]));
    RoutingModuleNameValueAcquired = true;
}
if ((RoutingModuleNameValueAcquired == false))
{
    object data = global::System.Runtime.Remoting.Messaging.CallContext.LogicalGetData("RoutingModuleName");
    if ((data != null))
    {
        this._RoutingModuleNameField = ((string)(data));
    }
}
