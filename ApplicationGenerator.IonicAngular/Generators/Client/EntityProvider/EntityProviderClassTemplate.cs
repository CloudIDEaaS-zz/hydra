...
namespace AbstraX.Generators.Client.EntityProvider
{
    ...
    #line 1 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
...
#line hidden
        ...
        public override string TransformText()
        {
            ...
            #line 24 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
...
export class ");
            ...
            #line 48 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            ...
            #line 49 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            ...
            #line 50 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
    ...
    if (this.IsIdentityEntity)
    {
            ...
            #line 54 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            ...
            #line 55 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            ...
            this.Write("\";\r\n  public accessTokenInfo: AccessTokenInfo;\r\n  private navController : NavCont" +
                    ...
                    "rivate componentFactoryResolver: ComponentFactoryResolver, private injector: Inj" +
                    "ector)\r\n  {\r\n    this.roles = new List<string>();\r\n    this.roles.push(\"{0000000" +
                    "0-0000-0000-0000-000000000000}\");\r\n  }\r\n\r\n  login(accountInfo: { userName: strin" +
                    "g, password: string }) {\r\n    let authorizationBasic = btoa(this.clientId + \':\' " +
                    "+ this.clientSecret);\r\n    let seq = this.api.authenticate(\'oauth/token\', accoun" +
                    "tInfo, authorizationBasic).share();\r\n\r\n    seq.subscribe((res: any) => {\r\n      " +
                    ...
                    " List<string>(rolesString.split(\",\"));\r\n  }\r\n\r\n  public canView(component: Compo" +
                    "nent): Promise<boolean> {\r\n\r\n    let name = component[\"name\"];\r\n\r\n    try {\r\n   " +
                    "   if (component[\"AuthorizedFor\"]) {\r\n\r\n        let authorizedFor = new List<str" +
                    "ing>(component[\"AuthorizedFor\"]);\r\n\r\n        if (authorizedFor.any(a => this.rol" +
                    "es.any(r => r == a))) {\r\n          return Promise.resolve(true);\r\n        }\r\n   " +
                    "     else {\r\n          throw `User not authorized for ${ name }`;\r\n        }\r\n  " +
                    "    }\r\n    }\r\n    catch (e) {\r\n      console.error(e);\r\n      throw e;\r\n    }\r\n\r" +
                    "\n    return Promise.resolve(true);\r\n  }\r\n\r\n  public handleDefaultRoute(handler: " +
                    "(r: any) => string): string {\r\n      let role = this.roles.last();\r\n\r\n      retu" +
                    "rn handler(role);\r\n  }\r\n\r\n");
            
            #line 142 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
    ...
    else
    {
            ...
            #line 151 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
    ...
    if (this.CustomQueries != null)
    {
        foreach (var query in this.CustomQueries)
        {
            ...
            #line 162 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            ...
            #line 163 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            ...
            #line 165 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            ...
            #line 169 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            ...
            #line 170 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            ...
            #line 175 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(queryLambdaParameter));
            ...
            #line 177 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
    ...
    foreach (var relatedEntity in this.RelatedEntities)
    {
        ...
        if (relatedEntity.IsEntitySet)
        {
            ...
            #line 191 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            ...
            #line 192 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(this.EntityName));
            ...
            #line 194 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            ...
            #line 197 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
        ...
        else
        {
            ...
            #line 208 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(property));
            ...
            #line 209 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(this.EntityName));
            ...
            #line 211 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(lambdaParameter));
            ...
            #line 214 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            ...
            #line 218 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(this.EntityName));
            ...
            #line 219 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(this.EntityName));
            ...
            #line 221 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(lambdaParameter));
            ...
            #line 224 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(this.EntityName));
            ...
            #line 225 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(modelVariable));
            ...
            #line 230 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(this.EntityName));
            ...
            #line 231 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(modelVariable));
            ...
            #line 236 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(this.EntityName));
            ...
            #line 237 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\EntityProvider\EntityProviderClassTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(modelVariable));
