...
namespace AbstraX.Generators.Client.App
{
    ...
    #line 1 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\App\PageIndexTemplate.tt"
...
#line hidden
        ...
        public override string TransformText()
        {
            ...
            #line 15 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\App\PageIndexTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(this.HomePage.Name));
            
            #line default
            #line hidden
            this.Write("\";\r\n\r\n");
            
            #line 17 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\App\PageIndexTemplate.tt"
  if (this.MainPage != null)
    {
            ...
            #line 21 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\App\PageIndexTemplate.tt"
            ...
            #line 22 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\App\PageIndexTemplate.tt"
    ...
    else
    {
            ...
            #line 28 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\App\PageIndexTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(this.HomePage.Name));
            ...
            #line 29 "D:\MC\CloudIDEaaS\root\ApplicationGenerator.IonicAngular\Generators\Client\App\PageIndexTemplate.tt"
...
private global::AbstraX.Angular.Page _HomePageField;

/// <summary>
/// Access the HomePage parameter of the template.
/// </summary>
private global::AbstraX.Angular.Page HomePage
{
    get
    {
        return this._HomePageField;
    }
}
...
bool HomePageValueAcquired = false;
if (this.Session.ContainsKey("HomePage"))
{
    this._HomePageField = ((global::AbstraX.Angular.Page)(this.Session["HomePage"]));
    HomePageValueAcquired = true;
}
if ((HomePageValueAcquired == false))
{
    object data = global::System.Runtime.Remoting.Messaging.CallContext.LogicalGetData("HomePage");
    if ((data != null))
    {
        this._HomePageField = ((global::AbstraX.Angular.Page)(data));
    }
}
