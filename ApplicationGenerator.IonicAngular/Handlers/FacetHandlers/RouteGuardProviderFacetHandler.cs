...
namespace AbstraX.Handlers.FacetHandlers
{
    ...
    public class RouteGuardProviderFacetHandler : BaseNonPageFacetHandler
    {
        ...
        public override bool Process(IBase baseObject, Facet facet, IGeneratorConfiguration generatorConfiguration)
        {
            ...
            RouteGuardProviderGenerator.GenerateProvider(baseObject, providersPath, generatorConfiguration);
