...
using AbstraX.Generators.Client.UserDataProvider;
...
namespace AbstraX.Handlers.FacetHandlers
{
    ...
    public class UserDataProviderFacetHandler : BaseNonPageFacetHandler
    {
        ...
        public override bool Process(IBase baseObject, Facet facet, IGeneratorConfiguration generatorConfiguration)
        {
            ...
            UserDataProviderGenerator.GenerateProvider(baseObject, providersPath, generatorConfiguration);
