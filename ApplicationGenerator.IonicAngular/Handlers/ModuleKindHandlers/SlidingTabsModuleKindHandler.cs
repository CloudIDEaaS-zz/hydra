...
using AbstraX.Generators.Modules.SlidingTabsModule;
...
{
    [AngularModuleKindHandler(ModuleKind.AngularModule, UIKindGuids.SlidingTabsPage)]
    public class SlidingTabsModuleKindHandler : IModuleKindHandler
    {
        public float Priority => 1.0f;
        public event ProcessFacetsHandler ProcessFacets;

        public SlidingTabsModuleKindHandler()
        {
        }
        ...
        public bool Process(Enum moduleKind, IModuleObject moduleObject, Folder folder, IGeneratorConfiguration generatorConfiguration)
        {
            ...
            SlidingTabsModuleGenerator.GenerateModule(baseObject, angularModule, folder.fullPath, name, generatorConfiguration, imports, angularModule.UILoadKind, angularModule.UIKind);
