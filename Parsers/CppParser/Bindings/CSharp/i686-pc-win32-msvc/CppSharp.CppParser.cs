        ...
        namespace AST
        {
            ...
            public unsafe partial class MacroDefinition : global::CppSharp.Parser.AST.PreprocessedEntity, IDisposable
            {
                ...
                public int ColumnNumberStart
                {
                    get
                    {
                        return ((Internal*)__Instance)->ColumnNumberStart;
                    }

                    set
                    {
                        ((Internal*)__Instance)->ColumnNumberEnd = value;
                    }
                }
            ...
            public unsafe partial class MacroExpansion : global::CppSharp.Parser.AST.PreprocessedEntity, IDisposable
            {
                ...
                private MacroExpansion(MacroExpansion.Internal native, bool skipVTables = false) : this(__CopyValue(native), skipVTables)
                {
                    __ownsNativeInstance = true;
                    NativeToManagedMap[__Instance] = this;
                }

                protected MacroExpansion(void* native, bool skipVTables = false) : base((void*)null)
                {
                    __PointerAdjustment = 0;
                    if (native == null)
                        return;
                ...
                public MacroExpansion() : this((void*)null)
                {
                    __Instance = Marshal.AllocHGlobal(64);
                    __ownsNativeInstance = true;
                    NativeToManagedMap[__Instance] = this;
                ...
                public MacroExpansion(global::CppSharp.Parser.AST.MacroExpansion _0) : this((void*)null)
                {
                    __Instance = Marshal.AllocHGlobal(64);
                    __ownsNativeInstance = true;
                    NativeToManagedMap[__Instance] = this;
                ...
                public int ColumnNumberStart
                {
                    ...
                    set
                    {
                        ((Internal*)__Instance)->ColumnNumberStart = value;
                    }
                }
                ...
                public int ColumnNumberEnd
                {
                    get
                    {
                        return ((Internal*)__Instance)->ColumnNumberEnd;
                    }
...
namespace CppSharp
{
    namespace Parser
    {
        public unsafe partial struct SourceLocation
        {
            ...
            public SourceLocation(uint ID) : this()
            {
            ...
            public SourceLocation(global::CppSharp.Parser.SourceLocation _0) : this()
            {
