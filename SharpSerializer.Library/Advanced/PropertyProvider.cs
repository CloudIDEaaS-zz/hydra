...
namespace Polenter.Serialization.Advanced
{
    ...
    public class PropertyProvider
    {
        ...
        public PropertyProvider(bool ignoreReadOnlyProperties = false)
        {
        ...
        protected virtual bool IgnoreProperty(Serialization.Serializing.TypeInfo info, PropertyInfo property)
        {
            ...
            if (!property.CanRead || (!ignoreReadOnlyProperties && !property.CanWrite))
            {
                return true;
            }
        ...
        public virtual bool IgnoreCollectionItems(Serialization.Serializing.TypeInfo info)
        {
            return false;
        }
