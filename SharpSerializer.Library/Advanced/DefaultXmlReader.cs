...
namespace Polenter.Serialization.Advanced
{
    ...
    public sealed class DefaultXmlReader : IXmlReader
    {
        ...
        private IComplexValueConverter complexConverter;
        ...
        public DefaultXmlReader(ITypeNameConverter typeNameConverter, ISimpleValueConverter valueConverter, IComplexValueConverter complexConverter, XmlReaderSettings settings)
        {
