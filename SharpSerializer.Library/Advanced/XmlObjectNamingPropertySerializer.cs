...
namespace Polenter.Serialization.Advanced
{
    ...
    /// </remarks>
    public sealed class XmlObjectNamingPropertySerializer : PropertySerializer
    {
        ...
        public XmlObjectNamingPropertySerializer(IXmlWriter writer)
        {
        ...
        protected override void SerializeNullProperty(PropertyTypeInfo<NullProperty> property)
        {
            ...
            writeStartProperty(property.Name, property.Name, property.ValueType);
            writeEndProperty();
        }
        ...
        protected override void SerializeSimpleProperty(PropertyTypeInfo<SimpleProperty> property)
        {
            ...
            _writer.WriteAttribute(Attributes.ValueType, property.Property.Type.AssemblyQualifiedName);
        ...
        {
            writeStartProperty(referenceTarget.Name, referenceTarget.Name, null);
