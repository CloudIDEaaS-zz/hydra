    ...
    public static class GacUtil
    {
        ...
        public class AssemblyCacheEnum
        {
            ...
            public AssemblyCacheEnum(String assemblyName)
            {
                ...
                if (assemblyName != null)
                {
                    hr = CreateAssemblyNameObject(out fusionName, assemblyName, CreateAssemblyNameObjectFlags.CANOF_PARSE_DISPLAY_NAME, IntPtr.Zero);
                }
        ...
        public class AssemblyCacheInstallReferenceEnum
        {
            public AssemblyCacheInstallReferenceEnum(String assemblyName)
            {
                ...
                int hr = CreateAssemblyNameObject(out fusionName, assemblyName, CreateAssemblyNameObjectFlags.CANOF_PARSE_DISPLAY_NAME, IntPtr.Zero);

                if (hr >= 0)
                {
                    hr = CreateInstallReferenceEnum(out refEnum, fusionName, 0, IntPtr.Zero);
                }
        ...
        public static string GetAssemblyLocation(string assemblyName)
        {
            ...
            int hr;
            var nameParts = AssemblyExtensions.GetNameParts(assemblyName);

            if (nameParts.AssemblyName == "mscorlib")
            {
            ...
            hr = CreateAssemblyCache(out assemblyCache, 0);
