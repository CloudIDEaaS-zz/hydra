...
namespace BTreeIndex.Collections.Generic.BTree
{
	...
	public class BTreeDictionary<TKey, TValue> : IBTreeDictionary<TKey, TValue>
	{
		internal class BTreeEnumeratorValue : BTreeEnumerator<TValue>
		{
			...
			public override TValue Current
			{
				get
				{
					...
					throw new InvalidOperationException(BTreeIndex.Collections.BTree.BTree.GetStringResource("ResetError"));
				}
			}
		}
		...
		{
			btree = new BTreeIndex.Collections.Generic.BTree.BTreeAlgorithm<TKey,TValue>(Comparer);
		}
		/// <summary>
		...
		{
			btree = new BTreeIndex.Collections.Generic.BTree.BTreeAlgorithm<TKey,TValue>(SlotLen);
		}
		/// <summary>
		...
		/// </summary>
		public BTreeIndex.Collections.BTree.SortOrderType SortOrder
		{
			get
			{
		...
		{
			if (this.SortOrder ==
				BTreeIndex.Collections.BTree.SortOrderType.Ascending)
				return btree.MoveNext();
			...
			int arrayIndex)
		{
			...
			if (Count > array.Length - arrayIndex)
				throw new ArgumentException(BTreeIndex.Collections.BTree.BTree.GetStringResource("BTreeHasMoreElems"));
			if (MoveFirst())
			{
				do
				{
		...
		private BTreeIndex.Collections.BTree.SortOrderType CurrentSortOrder = BTreeIndex.Collections.BTree.SortOrderType.Ascending;
#if !DEVICE
