...
namespace Utils.Controls.ColorPicker
{
    ...
    public partial class ColorHexagon: UserControl
    {
        ...
        public Color SelectedColor
        {
            ...
            set
            {
                var hexagonElement = this.hexagonElements.FirstOrDefault(e => e.CurrentColor.R == value.R && e.CurrentColor.G == value.G && e.CurrentColor.B == value.B && e.CurrentColor.A == value.A);

                if (hexagonElement != null)
                {
                    hexagonElement.IsSelected = true;
                }
            }
        }
        #endregion
