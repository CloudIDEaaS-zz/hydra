...
namespace Utils
{
    ...
    public static class IDispatchUtility
    {
        ...
        private static bool TryGetDispId(IDispatch dispatch, string name, out int dispId)
        {
            ...
            bool result = false;
            System.Runtime.InteropServices.CustomMarshalers.TypeToTypeInfoMarshaler mar = null;
        ...
        private interface IDispatch
        {
            ...
            void GetTypeInfo(int typeInfoIndex, int lcid, [MarshalAs(UnmanagedType.CustomMarshaler,MarshalTypeRef = typeof(System.Runtime.InteropServices.CustomMarshalers.TypeToTypeInfoMarshaler))] out Type typeInfo);
            [PreserveSig]
