...
namespace Utils
{
    ...
    public class ctrlSplitCheckbox : CheckBox
    {
        ...
        protected override void OnMouseUp(MouseEventArgs mevent)
        {
            ...
            if (ContextMenuStrip == null || !ContextMenuStrip.Visible)
            {
                ...
                if ((Bounds.Contains(Parent.PointToClient(Cursor.Position)) && !(_dropDownRectangle.Contains(mevent.Location)) && _dropDownButton))
                {
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            if (this.Checked)
            {
                ...
                ButtonRenderer.DrawButton(g, backgroundBounds, PushButtonState.Pressed);
            ...
            {
                ButtonRenderer.DrawButton(g, bounds, PushButtonState.Normal);
            }
