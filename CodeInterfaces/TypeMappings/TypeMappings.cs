...
namespace CodeInterfaces.TypeMappings
{
    public static class TypeMapper
    {
        ...
        public class TypeMappings
        {
            ...
            public TypeMappings()
            {
                var path = "CodeInterfaces.TypeMappings.Schemas.XMLSchema.xsd";
                Stream stream;

                executingAssembly = Assembly.GetExecutingAssembly();
                assemblyName = executingAssembly.GetNameParts().AssemblyName;
                ...
                if (stream == null)
                {
                    if (stream == null)
                    {
                        stream = executingAssembly.GetManifestResourceStream(assemblyName + "." + path);
                    }
                ...
                if (serverVersion)
                {
                    LoadMapping("CodeInterfaces.TypeMappings.Mappings.DataTypes.xslt");
                    LoadMapping("CodeInterfaces.TypeMappings.Mappings.DotNetTypes.xslt");
                    LoadMapping("CodeInterfaces.TypeMappings.Mappings.ObjectTypes.xslt");
                    LoadMapping("CodeInterfaces.TypeMappings.Mappings.ScriptTypes.xslt");
                }
                else
                {
                    LoadMapping("CodeInterfaces.TypeMappings.Mappings.DataTypes.xslt");
