...
namespace Agent.Sdk
{
    ...
    public class AgentTaskPluginExecutionContext : ITraceWriter
    {
        ...
        public AgentTaskPluginExecutionContext()
            : this(null)
        {
            System.Net.Http.ObjectContent<Microsoft.TeamFoundation.DistributedTask.WebApi.TaskLog> objectContent;
            System.Net.Http.ObjectContent<Microsoft.TeamFoundation.DistributedTask.WebApi.TimelineRecordFeedLinesWrapper> objectContent1;
            System.Net.Http.ObjectContent<Microsoft.VisualStudio.Services.WebApi.VssJsonCollectionWrapper<System.Collections.Generic.IEnumerable<Microsoft.TeamFoundation.DistributedTask.WebApi.TimelineRecord>>> objectContent2;
        }
