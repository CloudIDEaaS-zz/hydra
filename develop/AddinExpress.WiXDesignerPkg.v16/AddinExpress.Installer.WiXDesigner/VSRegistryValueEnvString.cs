...
{
	internal class VSRegistryValueEnvString : VSRegistryValueBase
	{
		[Browsable(true)]
		...
		public VSRegistryValueEnvString()
		{
		}

		public VSRegistryValueEnvString(WiXProjectParser project, WiXRegistryValue wixElement, VSComponent parentComponent, VSRegistryValues collection) : base(project, wixElement, parentComponent, collection)
		{
		}

		protected override VSRegistryValueType GetValueType()
		{
			return VSRegistryValueType.vsdrvtEnvironmentString;
		}
