...
using FileSystemEventHandler = AbstraX.FolderStructure.FileSystemEventHandler;
...
namespace AbstraX
{
    ...
    public interface IGeneratorConfiguration : IPackageCacheStatusProvider, ITypesProvider, ITemplateEngineHostManager
    {
        /// <summary>   Gets the predictive analytics. </summary>
        ///
        /// <value> The predictive analytics. </value>

        Dictionary<MemberInfo, List<PredictiveAnalytic>> PredictiveAnalytics { get; }

        /// <summary>   Logs status message. </summary>
        ///
        /// <param name="message">  The message. </param>

        void LogStatusInformation(string message);

        /// <summary>   Logs status error. </summary>
        ///
        /// <param name="message">  The message. </param>

        void LogStatusError(string message);

        /// <summary>   Logs user interface hierarchy path. </summary>
        ///
        /// <param name="path"> Full pathname of the file. </param>

        void LogUIHierarchyPath(string path);

        /// <summary>   Logs user interface path tree. </summary>
        void LogUIPathTree(Utils.ObjectTree<UIPathItem> uiPathTree);
        ...
        /// <summary>   Handler, called when the get model type builder. </summary>
        ///
        /// <returns>   The model type builder handler. </returns>

        IModelTypeBuilderHandler GetModelTypeBuilderHandler();
        ...
        /// 
        event CreateInstanceEventHandler CreateInstance;
        ...
        /// <summary>   Gets the role defaults. </summary>
        ///
        /// <value> The role defaults. </value>

        Dictionary<Guid, Dictionary<string, object>> RoleDefaults { get; }
        ...
        IEntityObjectWithFacets IdentityEntity { get; }

        /// <summary>   Gets template engine host. </summary>
        ///
        /// <returns>   The template engine host. </returns>

        ITemplateEngineHost GetTemplateEngineHost();
        ...
        HandlerStackItem HandleFacets(IEntityObjectWithFacets entityWithFacets, bool isIdentityEntity = false);
        ...
        string SetInstallStatus(string status);
        ...
        T GetHandler<T>(params object[] args) where T : IHandler;
        ...
        IDynamicModuleBuilder GetDynamicModuleBuilder();
        ...
        void AddFacets(IEntityObjectWithFacets entityWithFacets);
        ...
        File CreateFile(System.IO.FileInfo fileInfo, string output, FileKind fileKind, IModuleAssembly moduleAssembly = null);
