// file:	Models\RestService\RestModel.cs
//
// summary:	Implements the REST model class
...
{
    /// <summary>   A data Model for the rest. </summary>
    ///
    /// <remarks>   CloudIDEaaS, 11/21/2020. </remarks>

    [DebuggerDisplay(" { Name } ")]
    public class RestModel : RestEntityBase, IElement, IRootWithOptions, IModel
    {
