...
namespace AbstraX
{
    ...
    public class AppStore : System.Configuration.ConfigurationElement
    {
        /// <summary>   Gets or sets the arguments kind. </summary>
        ///
        /// <value> The arguments kind. </value>

        public string AppStoreType { get; set; }

        /// <summary>   Gets or sets the assembly. </summary>
        ///
        /// <value> The assembly. </value>

        public AppStoreAssembly Assembly { get; set; }
    }
    ...
    public class AppStoreAssembly : System.Configuration.ConfigurationElement
    {
    ...
    public class AppStoresSection : IConfigurationSectionHandler
    {
        ...
        {
            var appStores = new List<AppStore>();

            foreach (XmlNode childNode in section.ChildNodes)
            {
                var assemblyNode = childNode.ChildNodes.OfType<XmlElement>().Single();

                appStores.Add(new AppStore
                {
                    AppStoreType = childNode.Attributes["appStoreType"].Value,
                    Assembly = new AppStoreAssembly() { name = assemblyNode.Attributes["name"].Value, version = assemblyNode.Attributes["version"].Value, publicKeyToken = assemblyNode.Attributes["publicKeyToken"].Value, culture = assemblyNode.Attributes["culture"].Value, }
                });
            }
