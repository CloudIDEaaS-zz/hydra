...
namespace AbstraX.DataAnnotations
{
    ...
    public class FormFieldAttribute : NavigableAttribute
    {
        ...
        /// <param name="formFieldKind">        (Optional) The field kind. </param>

        public FormFieldAttribute(string uiHierarchyPath, FormFieldKind formFieldKind = FormFieldKind.DataType) : base(uiHierarchyPath)
        {
            this.FormFieldKind = formFieldKind;
        }
