...
namespace AbstraX.DataAnnotations
{
    ...
    public enum UIKind
    {
        ...
        BlankPage,
        /// <summary>   An enum constant representing the about page option. </summary>
        [KindGuid(UIKindGuids.AboutPage, UIFeatureKind.Standard)]
        AboutPage,
        /// <summary>   An enum constant representing the license page option. </summary>
        [KindGuid(UIKindGuids.LicensePage, UIFeatureKind.Standard)]
        LicensePage,
        /// <summary>   An enum constant representing the support page option. </summary>
        [KindGuid(UIKindGuids.SupportPage, UIFeatureKind.Standard)]
        SupportPage,
    ...
    public static class UIKindGuids
    {
        ...
        public const string AboutPage = "{D7570935-B938-477F-83B8-3AC5BD2ADABE}";
        /// <summary>   The support page. </summary>
        public const string SupportPage = "{131DB625-5585-4ABB-BD72-AF2525F0EF35}";
        /// <summary>   The license page. </summary>
        public const string LicensePage = "{066CC77C-DABC-46F9-BE6E-B8BD2C3C8732}";
