...
namespace AbstraX
{
    ...
    public interface IEntitiesModelGeneratorHandler : IHandler
    {
        ...
        bool Process(EntityDomainModel entityDomainModel, BusinessModel businessModel, AppUIHierarchyNodeObject appUIHierarchyNodeObject, Guid projectType, string projectFolderRoot, IVSProject entitiesProject, IGeneratorConfiguration generatorConfiguration);
    }
}
